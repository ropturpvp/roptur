function sendammo(option){
	switch (option)
	{
		case 1:
				...
				document.getElementById("valor1").innerHTML = (document.getElementById("cantidad1").value*10);
				break;
		...
		case 2:
				...
				document.getElementById("valor2").innerHTML = (document.getElementById("cantidad2").value*12);
				break;
		...
		case 3:
				...
				document.getElementById("valor3").innerHTML = (document.getElementById("cantidad3").value*18);
				break;
		...
		case 4:
				...
				document.getElementById("valor4").innerHTML = (document.getElementById("cantidad4").value*22);
				break;
		...
		case 5:
				...
				document.getElementById("valor5").innerHTML = (document.getElementById("cantidad5").value*30);
				break;
		...
		case 6:
				...
				document.getElementById("valor6").innerHTML = (document.getElementById("cantidad6").value*18);
				break;
		...
		case 7:
				...
				document.getElementById("valor7").innerHTML = (document.getElementById("cantidad7").value*22);
				break;
		...
		case 8:
				...
				document.getElementById("valor8").innerHTML = (document.getElementById("cantidad8").value*25);
				break;
		...
		case 9:
				...
				document.getElementById("valor9").innerHTML = (document.getElementById("cantidad9").value*22);
				break;
		...
		case 10:
				...
				document.getElementById("valor10").innerHTML = (document.getElementById("cantidad10").value*28);
				break;
		...
		case 11:
				...
				document.getElementById("valor11").innerHTML = (document.getElementById("cantidad11").value*32);
				break;
		...
		case 12:
				...
				document.getElementById("valor12").innerHTML = (document.getElementById("cantidad12").value*26);
				break;
		...
		case 13:
				...
				document.getElementById("valor13").innerHTML = (document.getElementById("cantidad13").value*32);
				break;
		...
		case 14:
				...
				document.getElementById("valor14").innerHTML = (document.getElementById("cantidad14").value*34);
				break;
		...
		case 15:
				...
				document.getElementById("valor15").innerHTML = (document.getElementById("cantidad15").value*45);
				break;
		...
		case 16:
				...
				document.getElementById("valor16").innerHTML = (document.getElementById("cantidad16").value*50);
				break;
		...
		case 17:
				...
				document.getElementById("valor17").innerHTML = (document.getElementById("cantidad17").value*42);
				break;
		...
		case 18:
				...
				document.getElementById("valor18").innerHTML = (document.getElementById("cantidad18").value);
				break;
				
		case 19:
				document.getElementById("set").value = "Element";
				document.getElementById("quantity").value = document.getElementById("cantidad19").value;
				document.getElementById("valor19").innerHTML = (document.getElementById("cantidad19").value*100);
				break;
	}
}